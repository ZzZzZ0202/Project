Public Class EmployeeBarangayServices
    ...
    Private Sub btnsocialservices_Click(sender As Object, e As EventArgs) 
        ' Open Social Services Form
        Dim EmployeeSocialWalfareServices As New EmployeeSocialWalfareServices()
        EmployeeSocialWalfareServices.Show()
        Me.Hide()
    End Sub
End Class